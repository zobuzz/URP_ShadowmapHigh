	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput vert ( VertexInput v  )
			{
				...
				//add by sj
				o.shadowVertex = mul(_ZorroShadowMatrix, float4(positionWS.xyz, 1.0f));
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				//add by sj
					...
					inputData.bakedAtten = SampleShadowMask(IN.lightmapUVOrVertexSH.xy);
				#endif    
				...
				//add by sj   exponential shadowmap 
		...
		Pass
		{
			...
			VS_Output vert(VS_Input v)
			{
				...
				float4 positionWS = mul(GetObjectToWorldMatrix(), float4(v.vertex.xyz, 1.0));

				o.vertex = TransformWorldToHClip(positionWS.xyz);

				//o.shadowVertex = positionWS;
				o.shadowVertex = mul(_ZorroShadowMatrix, float4(positionWS.xyz, 1.0));
			...
			{
				float4 color;
				//depth is GL ccv (-1,1) , change to 0 - 1
				float depth = IN.shadowVertex.z / IN.shadowVertex.w * 0.5 + 0.5;	

				//float4 shadowVertex = mul(_ZorroShadowMatrix, float4(IN.shadowVertex.xyz, 1.0));
				//float depth = shadowVertex.z / shadowVertex.w * 0.5 + 0.5;


				float t1 = depth * 255.0f;
				color.r = floor(t1) / 255.0f;

				float t2 = frac(t1) * 255.0f;
				color.g = floor(t2) / 255.0f;

				float t3 = frac(t2) * 255.0f;
				color.b = floor(t3) / 255.0f;

				float t4 = frac(t3) * 255.0f;
				color.a = floor(t4) / 255.0f;
...
/*ASEBEGIN
Version=17900
-1193;-340;1186;1845;593;923.5;1;True;True
Node;AmplifyShaderEditor.SamplerNode;7;-420,69.5;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;2;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;ShadowTest;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;12;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;13;Workflow;1;Surface;0;  Blend;0;Two Sided;1;Cast Shadows;1;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;False;False;False;False;;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;6;0,0;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;True;0;False;-1;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;True;True;True;True;True;0;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;0
WireConnection;2;0;7;0
ASEEND*/
//CHKSM=D5FEEE3D5B8A738D8365BFD16A41BED124A97BC6